...
function Experience() {
  return (
	...
	<div className='absolute top-32 w-full h-auto left-10 '>
		...
		<div className='justify-center flex items-center '><h2 className='font-bold text-2xl p-2'>Work Experience</h2></div>
		<div className=' max-w-[90%] h-auto p-2 justify-center items-center '>
			
			{
             ...
             experience.map((data , index)=>(
				...
				<div key={index} className='h-auto p-4 m-6  shadow-md shadow-gray-500 text-gray-200 '>
