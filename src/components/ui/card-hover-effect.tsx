  ...
  return (
    ...
    <div
      ...
      className={cn(
        ...
        " mt-32  p-3 grid grid-cols-1  lg:m-24  py-10",
        className
      )}
    >
         <div className="flex justify-center items-center text-3xl font-bold">
          <h2 className="lg:text-4xl bg-gradient-to-l  from-blue-700 p-1"  >Project</h2>
         </div>
      {items.map((item, idx) => (
        <Link
          href={item?.link}
        ...
        >
          ...
          <Card>
            ...
            className="w-full h-64 object-cover  lg:p-4"  />
